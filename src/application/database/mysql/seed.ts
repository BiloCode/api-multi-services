...
//User
const user = [
  { fullName : 'Billy Paredes Aycho' , username : 'billy' , password : '123456' , districtId : 1 ,description:'Usuario comun' },
  { fullName : 'Imanol Mayo' , username : 'imanol' , password : '123456', districtId : 3 , description:'Usuario comun' },
  { fullName : 'Ttito chavez' , username : 'ttito' , password : '123456', districtId : 2, description:'Usuario comun' },
  { fullName : 'Cezar jefe' , username : 'cezar' , password : '123456', districtId : 2, description:'Usuario comun' },
  { fullName : 'Usuario sin foto' , username : 'usuario' , password : '123456', districtId : 2, description:'Usuario comun' }
];
