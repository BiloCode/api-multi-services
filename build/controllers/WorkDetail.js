...
var WorkDetailController = /** @class */ (function () {
    function WorkDetailController() {
        var _this = this;
        this.create = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, state, price, description, workerId, userId, detail, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, state = _a.state, price = _a.price, description = _a.description, workerId = _a.workerId, userId = _a.userId;
                        return [4 /*yield*/, WorkDetail_1.default.create({
                                state: state,
                                price: price,
        ...
        this.get = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, WorkDetail_1.default.findAll({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.body.id;
                        return [4 /*yield*/, WorkDetail_1.default.findByPk(id, {
                                attributes: ['id', 'createdAt', 'state', 'price', 'description'],
                                include: [
                                    {
                                        model: User_1.default,
...
exports.default = WorkDetailController;
